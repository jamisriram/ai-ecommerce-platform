...
export const productReviewDeleteReducer = (state = {}, action) => {
    switch (action.type) {
        case 'PRODUCT_DELETE_REVIEW_REQUEST': return { loading: true };
        case 'PRODUCT_DELETE_REVIEW_SUCCESS': return { loading: false, success: true };
        case 'PRODUCT_DELETE_REVIEW_FAIL': return { loading: false, error: action.payload };
        case 'PRODUCT_DELETE_REVIEW_RESET': return {};
        default: return state;
    }
};
